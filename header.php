...
echo <<<_INIT
    ...
    echo <<<_MAIN
        <title>ChatBox: $user</title>
        
        </head>
        <body>
            <div data-role='page'>
                <div data-role='header'>
                    <div id='logo' class='center'>ChatBox</div>
        ...
        echo <<<_LOGGEDIN
            <div class='center'>
                ...
                <a data-role='button' data-inline='true' data-icon='user'
                    data-transition="slide" href='members.php?view=$user&r=$randstr'>Members</a>
                <a data-role='button' data-inline='true' data-icon='heart'
                    data-transition="slide" href='friends.php?view=$user&r=$randstr'>Friends</a>
                <a data-role='button' data-inline='true' data-icon='mail'
                    data-transition="slide" href='messages.php?view=$user&r=$randstr'>Messages</a>
                <a data-role='button' data-inline='true' data-icon='edit'
                    data-transition="slide" href='profile.php?view=$user&r=$randstr'>Edit Profile</a>
                <a data-role='button' data-inline='true' data-icon='action'
                    data-transition="slide" href='logout.php?view=$user&r=$randstr'>Log out</a>
            </div>     
        _LOGGEDIN;
    }
    else 
